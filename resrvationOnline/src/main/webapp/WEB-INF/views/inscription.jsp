        ...
        <div class="container">
            <div class="signup-content">
                <div class="signup-form">
                    ...
                    <form:form method="post" modelAttribute="student" action="registerForm">
                        ...
                        <div class="form-group">
                            ...
                            <form:input path="email" type="email" name="email" id="email" pattern="[a-z0-9._%+-]+@[student]+.+[a-z]{2,}$"  title="enter your youcode email" placeholder="Your Email" />
                        </div>
                        <div class="form-group">
                            <label for="email"><i class="zmdi zmdi-email"></i></label>
                ...
                <div class="signup-image">
                    <figure><img src="<c:url value="/resources/images/Safi.jpg"/>" alt="sing up image"></figure>
